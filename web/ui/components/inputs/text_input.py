...
class TextInput(Component):
    ...
    def validate(self, value: str) -> bool:
        ...
        # Pattern validation
        if self.pattern:
            pattern_obj = self.pattern if hasattr(self.pattern, "match") else re.compile(self.pattern)
    ...
    def display(self) -> str:
        ...
        try:
            ...
            self.logger.error(f"Error displaying text input component: {str(e)}", exc_info=True)
