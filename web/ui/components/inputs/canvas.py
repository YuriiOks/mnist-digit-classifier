...
# File: web/ui/components/inputs/canvas.py
...
class DrawingCanvas(Component):
    ...
    def render(self) -> None:
        ...
        try:
            ...
            background_color = SettingsState.get_setting(
            ...
            with col2:
                ...
                try:
                    ...
                    st.error(
                        "Please install streamlit-drawable-canvas: pip install streamlit-drawable-canvas"
                    )
