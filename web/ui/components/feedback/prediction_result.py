        ...
        try:
            ...
            if self.prediction:
                ...
                with st.container():
                    ...
                    # User correction UI
                    st.markdown("<div class='prediction-correction'>", unsafe_allow_html=True)
                    ...
                    with col2:
                        if st.button("👎 No", key="thumbs_down"):
                            ...
                            st.markdown("<div class='correction-input'>", unsafe_allow_html=True)
                    ...
                    if probabilities:
                        st.markdown("<div class='prediction-distribution'>", unsafe_allow_html=True)
                ...
                st.info("No prediction available. Draw a digit or upload an image and click 'Predict'.")
            
        except Exception as e:
            self.logger.error(f"Error rendering prediction result: {str(e)}", exc_info=True)
