...
class DatabaseManager:
    ...
    def _get_connection(self):
        ...
        if not hasattr(self._local, 'conn') or self._local.conn is None:
            try:
                ...
                self._logger.debug(f"Created new connection for thread {threading.get_ident()}")
    ...
    def update_prediction(self, prediction_id: str, 
        ...
        try:
            ...
            for key, value in updates.items():
                if key in ('digit', 'confidence', 'input_type', 'user_correction'):
    ...
    def clear_predictions(self) -> bool:
        ...
        try:
            ...
            self._logger.info(f"Cleared all predictions, deleted {cursor.rowcount} records")
            return True
        except sqlite3.Error as e:
