...
def main():
    ...
    # Tabs
    tab1, tab2, tab3 = st.tabs(["🔍 Live Testing", "📈 Performance Metrics", "🔄 History"])
        ...
        with col2:
            ...
            if predict_button and canvas_result.image_data is not None:
                ...
                if result:
                    ...
                    st.markdown(f"- Total: **{preprocessing_time + inference_time:.2f} ms**")
        ...
        if api_available:
            ...
            if metrics:
                ...
                with col3:
                    ...
                    st.markdown(f"- Throughput: **{1000/total_metrics.get('avg', 1):.2f} img/s**")
    ...
    with tab3:
        ...
        if st.session_state.history:
            ...
            if 'timestamp' in history_df.columns and len(history_df) > 1:
                ...
                ax.plot(history_df['timestamp'], history_df['total_time_ms'], marker='o')
                ax.set_xlabel('Time')
