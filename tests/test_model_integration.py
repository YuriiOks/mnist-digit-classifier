...
class TestModelIntegration(unittest.TestCase):
    ...
    def test_health_check(self):
        ...
        self.assertTrue(result, "Health check should return True if model API is available")
    
    def test_image_preprocessing(self):
        """Test image preprocessing."""
        # Test with PIL Image
        encoded = DigitClassifier.preprocess_image(self.test_image)
        self.assertIsInstance(encoded, str, "Preprocessing PIL Image should return a string")
        
        # Test with bytes
        encoded = DigitClassifier.preprocess_image(self.test_image_bytes)
        self.assertIsInstance(encoded, str, "Preprocessing bytes should return a string")
        
        # Test with numpy array
        import numpy as np
        array = np.array(self.test_image)
        encoded = DigitClassifier.preprocess_image(array)
        self.assertIsInstance(encoded, str, "Preprocessing numpy array should return a string")
